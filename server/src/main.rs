...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route(
            ...
            get(admin::registration_applications),
        )
        .route(
            "/admin/registration-applications/count",
            get(admin::registration_application_count),
        )
        .route(
            "/admin/registration-applications/{application_id}/approve",
            post(admin::approve_registration_application),
        )
        .route(
            "/admin/registration-applications/{application_id}/reject",
            post(admin::reject_registration_application),
        )
        ...
        .route(
            ...
            post(auth::register_application),
        )
