...
这是 macOS 和 Windows 客户端共用的云端 API。图片仍由客户端本地渲染，服务端负责账号、配置同步、文案库、AI 网关和后台管理。
...
macOS 原型清单见 `docs/MACOS_CLOUD_PROTOTYPE_CHECKLIST.md`，Windows 验收清单见 `docs/WINDOWS10_RELEASE.md`。
